            ...
            <Box className={`${styles["top-back-container"]} `}>
                ...
                >
                    <Toolbar className={`${styles["toolbar-container"]}`}>
                        ...
                        <button className={`${styles['bookmark']}`}><BookmarkBorderIcon style={{color: 'var(--bg-layer1)', fontSize: '30px'}} /></button>
                    </Toolbar>
                </AppBar>
            </Box>

            { Object.keys(unitData).length !== 0 && <UnitDetails unit={unitData}/> }
        </div>
    );
};
